<template>
  <header>
    <nav
        class="flex items-center border-opacity-25 justify-between flex-wrap bg-white p-6 fixed top-0 w-screen border-b border-blue-500 border-solid z-50">
      <div class="flex items-center flex-shrink-0 mr-6">

        <svg
            class="fill-current h-6 w-6 mr-2 text-blue-500 mt-1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="font-semibold text-xl tracking-tight">Tyson McCarney</span>
      </div>
